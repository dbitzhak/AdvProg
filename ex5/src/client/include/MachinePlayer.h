...
public:
	...
	*The input: GameLogic in use, GraphicInterface derived 
	 class, char to be used to identify the Player
...
private:
	...
	*The function operation: For each of the possible moves 
	 simulates all the possible answers from the opponent
	********************************************************/
	...
	*The function operation: Parses through the Board 
	 counting Cells
	********************************************************/
	...
	*The input: Board
	*The output: Return the total number of enemy Cells in 
	 their best play
	*The function operation: Simulates every possible answer 
	 and counts their results
	********************************************************/
