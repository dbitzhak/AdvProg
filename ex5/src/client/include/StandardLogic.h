...
Responsible for implementing the GameLogic functions in 
 accordance to the StandardRules
*******************************************************/
...
public:
	...
	*The output: None
	*The function operation: Starts a match between the two 
	 players, by calling the necessary functions for setting
	 up the match
	********************************************************/
	...
	*The input: Non
	*The output: bool false if there are possible moves for 
	 one of the players, false otherwise.
	...
	*The function operation: Counts the number of pieces
	 with each player's char and, returns the player with 
	...
	*The input: None.
	*The output: None
	*The function operation: Calls the respective player to 
	 play and verifies if a valid move was done and passes 
	...
	*The input: Player, the player whose valid positions we 
	 want to check, Board to be checked.
	*The output: vector<Cell>
	*The function operation: checks all the Board for valid 
	 positions
	********************************************************/
	...
	*The input: Target Board, start - Cell to have it's 
	 value changed Player - The player who made the move
	*The output: None
	*The function operation: Converts the Cell and calls 
	 the necessary functions for converting the valid pieces 
	 transformed by its change of state.
	********************************************************/
	...
	*The input: None
	*The output: The int pair representing the last played 
	 made in terms of x,y coordinates.
	*The function operation: Returns a previously stored 
	 int pair.
	********************************************************/
...
private:
	...
	*The input: Board to be checked, starting Cell (position), 
	 desired direction (rowDif,colDif) and target - Player's 
	 identifier
	*The output: None
	*The function operation: Checks if from the given position 
	 there is a direct path to a player's char not obstructed 
	 by empty Cells
	********************************************************/
	...
	*The input: Board to be checked, Cell of the desired 
	 position, Player for which the Cell;'s validity is
	 being checked
	*The output: bool true if valid, false otherwise.
	*The function operation: Checks if there is a direct 
	 path to a player's symbol-valued Cell, not obstructed 
	 by empty Cells
	********************************************************/
	...
	*The output: None
	*The function operation: Calls generalCheck on the Cells 
	...
	*The input:Target Board, Starting Cell, player's symbol
	*The output: None
	*The function operation: Calls generalCheck on the Cell's 
	 down side
	********************************************************/
	...
	*The input: Target Board,A Cell's vector representing a 
	 path in Board, the move player's value
	*The output: None
	*The function operation: Sets all the Cell's in the path 
	 to the player's identifying char
	********************************************************/
	void convertPath(vector<Cell> path, char value, Board *gameBoard);

	/******************************************************
	*Function name: propagateConversion()
	*The input: Target Board, Cell start, the Cell recently 
	 converted by a player
	*The output: None
	*The function operation: Looks for valid paths to Cells 
	 and then calls convertPath on them.
	********************************************************/
	void propagateConversion(Cell start, Board *gameBoard);
	
	/********************************************************************
	*Function name: stopMatch()
	*The input: None
	*The output: None
	*The function operation: Signals that the match should stop 
	 (through changing matchRunning to false)
	*********************************************************************/
	void stopMatch();
